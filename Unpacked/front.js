...
function showSettingsPage() {
    ...
    const createInputFieldWithToggle = (label, id, value) => {
    ...
    createInputFieldWithToggle("User ID", "auth-userId", authObj.userId || "");
    createInputFieldWithToggle("Device ID", "auth-deviceId", authObj.deviceId || "");
